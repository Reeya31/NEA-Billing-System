...
<?php
  if ($_SERVER["REQUEST_METHOD"] === "POST") 
  {
    ...
    // $customerQuery = "SELECT * FROM Customer WHERE CUSID = '$CID' AND DOB = '$dob' AND MobileNo = '$mobileno'";
    ...
    if ($customerResult->num_rows > 0) 
    {
      ...
      echo "<table>";
      //echo "<tr><th>CUSID</th><th>SCNO</th><th>FullName</th><th>Address</th><th>MobilNo</th><th>DOB</th></tr>";
